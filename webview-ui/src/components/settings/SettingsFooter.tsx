...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/canstralian/Codeflux-ai-kit" style={{ display: "inline" }}>
				github.com/canstralian/Codeflux-ai-kit
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/CodeFlux/" style={{ display: "inline" }}>
				reddit.com/r/CodeFlux
			</VSCodeLink>
		</p>
		<p className="italic">CodeFlux AI Kit v{version}</p>
