...
export const formatResponse = {
	...
	rooIgnoreError: (path: string) =>
		`Access to ${path} is blocked by the .codefluxignore file settings. You must try to continue in the task without using this file, or ask the user to update the .codefluxignore file.`,
